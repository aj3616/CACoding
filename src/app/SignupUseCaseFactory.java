...
public class SignupUseCaseFactory {
    ...
    , ClearViewModel clearViewModel, ClearUserDataAccessInterface clearUserDataAccessObject) {
        ...
        try {
            ...
            ClearController clearController = createUserClearCase(viewManagerModel, clearViewModel, clearUserDataAccessObject);
    ...
    private static ClearController createUserClearCase(ViewManagerModel viewManagerModel, ClearViewModel clearViewModel, ClearUserDataAccessInterface clearUserDataAccessObject) throws IOException {
